...
|---|---|---|---|---|---|---|
| absent | test if the buffer is absent | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#absent) | 8.0.0 | 8.0.0 |
...
| alert | alert will be generated by the rule | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/noalert.html) | 7.0.7 | 8.0.0 |
| app-layer-event | match on events generated by the App Layer Parsers and the protocol detection engine | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/app-layer.html#app-layer-event) | 4.1.5 | 8.0.0 |
| app-layer-protocol | match on the detected app-layer protocol | Unset | prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/app-layer.html#app-layer-protocol) | 4.1.5 | 8.0.0 |
| app-layer-state | match on events generated by the App Layer Parsers and the protocol detection engine | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/app-layer.html#app-layer-event) | 8.0.0 | 8.0.0 |
| asn1 |  | Unset | none | [Doc]() | 4.1.5 | 8.0.0 |
| base64_data | Content match base64 decoded data. | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/base64-keywords.html#base64-data) | 4.1.5 | 8.0.0 |
| base64_decode | Decodes base64 encoded data. | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/base64-keywords.html#base64-decode) | 4.1.5 | 8.0.0 |
| bsize | match on the length of a buffer | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#bsize) | 4.1.5 | 8.0.0 |
| bypass | call the bypass callback when the match of a sig is complete | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/bypass-keyword.html) | 4.1.5 | 8.0.0 |
| byte_extract | extract <num of bytes> at a particular <offset> and store it in <var_name> | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#byte-extract) | 4.1.5 | 8.0.0 |
| byte_jump | allow the ability to select a <num of bytes> from an <offset> and move the detection pointer to that position | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#byte-jump) | 4.1.5 | 8.0.0 |
| byte_math |  | Unset | none | [Doc]() | 6.0.0 | 8.0.0 |
| byte_test | extract <num of bytes> and perform an operation selected with <operator> against the value in <test value> at a particular <offset> | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#byte-test) | 4.1.5 | 8.0.0 |
| cip_service | match on CIP Service, and optionnally class and attribute | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/enip-keyword.html#cip_service) | 4.1.5 | 8.0.0 |
| classtype | information about the classification of rules and alerts | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/meta.html#classtype) | 4.1.5 | 8.0.0 |
| compress_whitespace | modify buffer to compress consecutive whitespace characters into a single one before inspection | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/transforms.html#compress-whitespace) | 4.1.5 | 8.0.0 |
| config |  | Unset | none | [Doc]() | 6.0.0 | 8.0.0 |
| content | match on payload content | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#content) | 4.1.5 | 8.0.0 |
| datarep | operate on datasets (experimental) | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dataset-keywords.html#datarep) | 5.0.0 | 8.0.0 |
| dataset | match sticky buffer against datasets (experimental) | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dataset-keywords.html#dataset) | 5.0.0 | 8.0.0 |
...
| depth | designate how many bytes from the beginning of the payload will be checked | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#depth) | 4.1.5 | 8.0.0 |
| detection_filter | alert on every match after a threshold has been reached | Unset | compatible with IP only rule | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/thresholding.html#detection-filter) | 4.1.5 | 8.0.0 |
| dhcp.leasetime | match DHCP leasetime | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dhcp-keywords.html#dhcp-leasetime) | 7.0.0 | 8.0.0 |
| dhcp.rebinding_time | match DHCP rebinding time | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dhcp-keywords.html#dhcp-rebinding-time) | 7.0.0 | 8.0.0 |
| dhcp.renewal_time | match DHCP renewal time | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dhcp-keywords.html#dhcp-renewal-time) | 7.0.0 | 8.0.0 |
| distance | indicates a relation between this content keyword and the content preceding it | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#distance) | 4.1.5 | 8.0.0 |
| dnp3.data | make the following content options to match on the re-assembled application buffer | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/dnp3-keywords.html#dnp3-data) | 5.0.0 | 8.0.0 |
...
| enip.cip_status | rules for detecting EtherNet/IP cip_status | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/enip-keyword.html#enip-cip-status) | 8.0.0 | 8.0.0 |
...
| flow.bytes_toserver | match number of bytes in a flow in to server dir | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/flow-keywords.html#flow-bytes) | 8.0.0 | 8.0.0 |
...
| http.host | sticky buffer to match on the HTTP Host buffer | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/http-keywords.html#http-host-and-http-raw-host) | 5.0.0 | 8.0.0 |
...
| icmpv4.hdr | sticky buffer to match on the ICMP v4 header | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/header-keywords.html#icmpv4-hdr) | 6.0.1 | 8.0.0 |
...
| krb5.cname | sticky buffer to match on Kerberos 5 client name | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/kerberos-keywords.html#krb5-cname) | 5.0.0 | 8.0.0 |
...
| mqtt.publish.message | sticky buffer to match on the MQTT PUBLISH message | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1mqtt-keywords.html#mqtt-publish-message) | 6.0.0 | 8.0.0 |
...
| rpc | match RPC procedure numbers and RPC version | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/payload-keywords.html#rpc) | 4.1.5 | 8.0.0 |
...
| sip.stat_code | sticky buffer to match on the SIP status code | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/sip-keywords.html#sip-stat-code) | 5.0.0 | 8.0.0 |
...
| stream_size | match on amount of bytes of a stream | Unset | prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/flow-keywords.html#stream-size) | 4.1.5 | 8.0.0 |
...
| tls.version | match on TLS/SSL version | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/tls-keywords.html#tls-version) | 4.1.5 | 8.0.0 |
...
| xbits | operate on bits | Unset | compatible with IP only rule | [Doc](https://docs.suricata.io/en/suricata-8.0.0-beta1/rules/xbits.html) | 4.1.5 | 8.0.0 |
