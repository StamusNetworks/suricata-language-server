...
|---|---|---|---|---|---|---|
| absent | test if the buffer is absent | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#absent) | 8.0.0 | 8.0.0 |
...
| alert | alert will be generated by the rule | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/noalert.html) | 7.0.7 | 8.0.0 |
| app-layer-event | match on events generated by the App Layer Parsers and the protocol detection engine | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/app-layer.html#app-layer-event) | 4.1.5 | 8.0.0 |
| app-layer-protocol | match on the detected app-layer protocol | Unset | supports firewall:prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/app-layer.html#app-layer-protocol) | 4.1.5 | 8.0.0 |
| app-layer-state | match on events generated by the App Layer Parsers and the protocol detection engine | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/app-layer.html#app-layer-event) | 8.0.0 | 8.0.0 |
| asn1 |  | Unset | none | [Doc]() | 4.1.5 | 8.0.0 |
| base64_data | Content match base64 decoded data. | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/base64-keywords.html#base64-data) | 4.1.5 | 8.0.0 |
| base64_decode | Decodes base64 encoded data. | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/base64-keywords.html#base64-decode) | 4.1.5 | 8.0.0 |
| bsize | match on the length of a buffer | Unset | supports firewall | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#bsize) | 4.1.5 | 8.0.0 |
| bypass | call the bypass callback when the match of a sig is complete | Unset | No option | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/bypass-keyword.html) | 4.1.5 | 8.0.0 |
| byte_extract | extract <num of bytes> at a particular <offset> and store it in <var_name> | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#byte-extract) | 4.1.5 | 8.0.0 |
| byte_jump | allow the ability to select a <num of bytes> from an <offset> and move the detection pointer to that position | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#byte-jump) | 4.1.5 | 8.0.0 |
| byte_math |  | Unset | none | [Doc]() | 6.0.0 | 8.0.0 |
| byte_test | extract <num of bytes> and perform an operation selected with <operator> against the value in <test value> at a particular <offset> | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#byte-test) | 4.1.5 | 8.0.0 |
| cip_service | match on CIP Service, and optionnally class and attribute | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/enip-keyword.html#cip_service) | 4.1.5 | 8.0.0 |
| classtype | information about the classification of rules and alerts | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/meta.html#classtype) | 4.1.5 | 8.0.0 |
| compress_whitespace | modify buffer to compress consecutive whitespace characters into a single one before inspection | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#compress-whitespace) | 4.1.5 | 8.0.0 |
| config |  | Unset | supports firewall | [Doc]() | 6.0.0 | 8.0.0 |
| content | match on payload content | Unset | supports firewall | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#content) | 4.1.5 | 8.0.0 |
| datarep | operate on datasets (experimental) | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dataset-keywords.html#datarep) | 5.0.0 | 8.0.0 |
| dataset | match sticky buffer against datasets (experimental) | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dataset-keywords.html#dataset) | 5.0.0 | 8.0.0 |
...
| depth | designate how many bytes from the beginning of the payload will be checked | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#depth) | 4.1.5 | 8.0.0 |
| detection_filter | alert on every match after a threshold has been reached | Unset | compatible with IP only rule | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/thresholding.html#detection-filter) | 4.1.5 | 8.0.0 |
| dhcp.leasetime | match DHCP leasetime | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dhcp-keywords.html#dhcp-leasetime) | 7.0.0 | 8.0.0 |
| dhcp.rebinding_time | match DHCP rebinding time | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dhcp-keywords.html#dhcp-rebinding-time) | 7.0.0 | 8.0.0 |
| dhcp.renewal_time | match DHCP renewal time | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dhcp-keywords.html#dhcp-renewal-time) | 7.0.0 | 8.0.0 |
| distance | indicates a relation between this content keyword and the content preceding it | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#distance) | 4.1.5 | 8.0.0 |
| dnp3.data | make the following content options to match on the re-assembled application buffer | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/dnp3-keywords.html#dnp3-data) | 5.0.0 | 8.0.0 |
...
| enip.cip_attribute | rules for detecting EtherNet/IP cip_attribute | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/enip-keyword.html#enip-cip-attribute) | 8.0.0 | 8.0.0 |
...
| flow | match on direction and state of the flow | Unset | supports firewall:prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/flow-keywords.html#flow) | 4.1.5 | 8.0.0 |
...
| http.content_len | http.content_len sticky buffer for the http content length header | Unset | sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/http-keywords.html#http-content-len) | 5.0.0 | 8.0.0 |
...
| http2.frametype | match on HTTP2 frame type field | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/http2-keywords.html#frametype) | 6.0.0 | 8.0.0 |
...
| itype | match on a specific ICMP type | Unset | supports firewall:prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/header-keywords.html#itype) | 4.1.5 | 8.0.0 |
...
| mdns.response.rrname | mDNS response rrname buffer | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/mdns-keywords.html#mdns-response-rrname) | 8.0.0 | 8.0.0 |
...
| sdp.repeat_time | sticky buffer to match on the SDP repeat time field | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/sdp-keywords.html#repeat-time) | 8.0.0 | 8.0.0 |
...
| snmp.community | SNMP content modifier to match on the SNMP community | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/snmp-keywords.html#snmp-community) | 5.0.0 | 8.0.0 |
...
| tls.alpn | sticky buffer to match the TLS ALPN buffer | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/tls-keywords.html#tls-alpn) | 8.0.0 | 8.0.0 |
...
| to_sha1 | convert to sha1 hash of the buffer | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#to-sha1) | 5.0.0 | 8.0.0 |
| to_sha256 | convert to sha256 hash of the buffer | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#to-sha256) | 4.1.5 | 8.0.0 |
| to_uppercase | convert buffer to uppercase | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#to_uppercase) | 7.0.3 | 8.0.0 |
| tos | match on specific decimal values of the IP header TOS field | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/header-keywords.html#tos) | 4.1.5 | 8.0.0 |
| ttl | check for a specific IP time-to-live value | Unset | prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/header-keywords.html#ttl) | 4.1.5 | 8.0.0 |
| udp.hdr | sticky buffer to match on the UDP header | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/header-keywords.html#udphdr) | 5.0.0 | 8.0.0 |
| udpv4-csum |  | Unset | none | [Doc]() | 4.1.5 | 8.0.0 |
| udpv6-csum |  | Unset | none | [Doc]() | 4.1.5 | 8.0.0 |
| uricontent | legacy keyword to match on the request URI buffer | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/http-keywords.html#uricontent) | 4.1.5 | 8.0.0 |
| urilen | match on the length of the HTTP uri | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/http-keywords.html#urilen) | 4.1.5 | 8.0.0 |
| url_decode | modify buffer to decode urlencoded data before inspection | Unset | No option:transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#url-decode) | 6.0.0 | 8.0.0 |
| vlan.id | match vlan id | Unset | prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/vlan-keywords.html#vlan-id) | 8.0.0 | 8.0.0 |
| vlan.layers | match number of vlan layers | Unset | prefilter | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/vlan-keywords.html#vlan-layers) | 8.0.0 | 8.0.0 |
| websocket.flags | match WebSocket flags | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/websocket-keywords.html#websocket-flags) | 8.0.0 | 8.0.0 |
| websocket.mask | match WebSocket mask | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/websocket-keywords.html#websocket-mask) | 8.0.0 | 8.0.0 |
| websocket.opcode | match WebSocket opcode | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/websocket-keywords.html#websocket-opcode) | 8.0.0 | 8.0.0 |
| websocket.payload | match WebSocket payload | Unset | No option:sticky buffer | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/websocket-keywords.html#websocket-payload) | 8.0.0 | 8.0.0 |
...
| within | indicate that this content match has to be within a certain distance of the previous content keyword match | Unset | none | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/payload-keywords.html#within) | 4.1.5 | 8.0.0 |
| xbits | operate on bits | Unset | compatible with IP only rule:supports firewall | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/xbits.html) | 4.1.5 | 8.0.0 |
| xor | modify buffer via XOR decoding before inspection | Unset | transform | [Doc](https://docs.suricata.io/en/suricata-8.0.0-rc1/rules/transforms.html#xor) | 7.0.0 | 8.0.0 |
